...
/*
    ...
    Cmdline:
        sokol-shdc --input shaders/sample-effect.glsl --output shaders/sample-effect.glsl.h --format sokol_impl --slang glsl410:glsl300es:hlsl4:metal_macos:metal_ios:wgsl
