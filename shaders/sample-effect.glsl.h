...
/*
    ...
    Cmdline:
        sokol-shdc --format sokol_impl --slang glsl410:glsl300es:hlsl4:metal_macos:metal_ios:wgsl --input shaders/sample-effect.glsl --output shaders/sample-effect.glsl.h
...
#define VIEW_effect_iTexChannel1 (1)
#define VIEW_effect_iTexChannel0 (0)
...
/*
    ...
    Texture2D<float4> iTexChannel1 : register(t1);
    SamplerState iSmpChannel1 : register(s1);
...
*/
static const uint8_t effect_vs_source_wgsl[672] = {
    ...
    0x20,0x6c,0x65,0x74,0x20,0x78,0x5f,0x32,0x30,0x20,0x3d,0x20,0x63,0x6f,0x6f,0x72,
    0x64,0x2e,0x78,0x79,0x3b,0x0a,0x20,0x20,0x67,0x6c,0x5f,0x50,0x6f,0x73,0x69,0x74,
    0x69,0x6f,0x6e,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x66,0x28,0x78,0x5f,0x32,0x30,
    0x2e,0x78,0x2c,0x20,0x78,0x5f,0x32,0x30,0x2e,0x79,0x2c,0x20,0x30,0x2e,0x30,0x66,
    0x2c,0x20,0x31,0x2e,0x30,0x66,0x29,0x3b,0x0a,0x20,0x20,0x74,0x65,0x78,0x55,0x56,
    0x20,0x3d,0x20,0x63,0x6f,0x6f,0x72,0x64,0x2e,0x7a,0x77,0x3b,0x0a,0x20,0x20,0x69,
    ...
    0x61,0x74,0x69,0x6f,0x6e,0x28,0x30,0x29,0x0a,0x20,0x20,0x74,0x65,0x78,0x55,0x56,
    0x5f,0x31,0x20,0x3a,0x20,0x76,0x65,0x63,0x32,0x66,0x2c,0x0a,0x20,0x20,0x40,0x6c,
    0x6f,0x63,0x61,0x74,0x69,0x6f,0x6e,0x28,0x31,0x29,0x0a,0x20,0x20,0x69,0x43,0x6f,
    ...
    0x74,0x20,0x7b,0x0a,0x20,0x20,0x63,0x6f,0x6f,0x72,0x64,0x20,0x3d,0x20,0x63,0x6f,
    ...
    0x67,0x6c,0x5f,0x50,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x2c,0x20,0x74,0x65,0x78,
    0x55,0x56,0x2c,0x20,0x69,0x43,0x6f,0x6c,0x6f,0x72,0x29,0x3b,0x0a,0x7d,0x0a,0x00,
...
/*
    ...
    @binding(1) @group(1) var iTexChannel1 : texture_2d<f32>;

    @binding(33) @group(1) var iSmpChannel1 : sampler;

    @binding(0) @group(1) var iTexChannel0 : texture_2d<f32>;

    @binding(32) @group(1) var iSmpChannel0 : sampler;

    var<private> texUV : vec2f;

    @binding(1) @group(0) var<uniform> x_48 : fs_uniforms;
    ...
    fn noise_vf2_(p : ptr<function, vec2f>) -> f32 {
      let x_23 = *(p);
      let x_25 = textureSample(iTexChannel1, iSmpChannel1, x_23);
      return x_25.x;
    }
    ...
    fn main_1() {
      ...
      var col : vec3f;
      let x_41 = texUV;
      let x_42 = textureSample(iTexChannel0, iSmpChannel0, x_41);
      tex_col = x_42.xyz;
      fog_uv = ((texUV * vec2f(x_48.iRatio, 1.0f)) * x_48.iZoom);
      param = (fog_uv - (x_48.iVelocity * x_48.iTime));
      let x_74 = noise_vf2_(&(param));
      f = x_74;
      param_1 = (fog_uv + vec2f((f * x_48.iWarpiness)));
      let x_84 = noise_vf2_(&(param_1));
      f = x_84;
      col = mix(tex_col, (vec3f(f) * iColor.xyz), vec3f(x_48.iPressure));
      fragColor = vec4f(col.x, col.y, col.z, 1.0f);
      return;
    }
...
*/
static const uint8_t effect_fs_source_wgsl[1733] = {
    0x64,0x69,0x61,0x67,0x6e,0x6f,0x73,0x74,0x69,0x63,0x28,0x6f,0x66,0x66,0x2c,0x20,
    0x64,0x65,0x72,0x69,0x76,0x61,0x74,0x69,0x76,0x65,0x5f,0x75,0x6e,0x69,0x66,0x6f,
    ...
    ,
    ...
    0x75,0x70,0x28,0x31,0x29,0x20,0x76,0x61,0x72,0x20,0x69,0x53,0x6d,0x70,0x43,0x68,
    0x61,0x6e,0x6e,0x65,0x6c,0x30,0x20,0x3a,0x20,0x73,0x61,0x6d,0x70,0x6c,0x65,0x72,
    0x3b,0x0a,0x0a,0x76,0x61,0x72,0x3c,0x70,0x72,0x69,0x76,0x61,0x74,0x65,0x3e,0x20,
    ...
    0x6d,0x3e,0x20,0x78,0x5f,0x34,0x38,0x20,0x3a,0x20,0x66,0x73,0x5f,0x75,0x6e,0x69,
    0x66,0x6f,0x72,0x6d,0x73,0x3b,0x0a,0x0a,0x76,0x61,0x72,0x3c,0x70,0x72,0x69,0x76,
    0x61,0x74,0x65,0x3e,0x20,0x69,0x43,0x6f,0x6c,0x6f,0x72,0x20,0x3a,0x20,0x76,0x65,
    0x63,0x34,0x66,0x3b,0x0a,0x0a,0x76,0x61,0x72,0x3c,0x70,0x72,0x69,0x76,0x61,0x74,
    0x65,0x3e,0x20,0x66,0x72,0x61,0x67,0x43,0x6f,0x6c,0x6f,0x72,0x20,0x3a,0x20,0x76,
    0x65,0x63,0x34,0x66,0x3b,0x0a,0x0a,0x66,0x6e,0x20,0x6e,0x6f,0x69,0x73,0x65,0x5f,
    0x76,0x66,0x32,0x5f,0x28,0x70,0x20,0x3a,0x20,0x70,0x74,0x72,0x3c,0x66,0x75,0x6e,
    ...
    ,
    ...
    0x66,0x3b,0x0a,0x20,0x20,0x76,0x61,0x72,0x20,0x63,0x6f,0x6c,0x20,0x3a,0x20,0x76,
    0x65,0x63,0x33,0x66,0x3b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,0x78,0x5f,0x34,0x31,
    0x20,0x3d,0x20,0x74,0x65,0x78,0x55,0x56,0x3b,0x0a,0x20,0x20,0x6c,0x65,0x74,0x20,
    0x78,0x5f,0x34,0x32,0x20,0x3d,0x20,0x74,0x65,0x78,0x74,0x75,0x72,0x65,0x53,0x61,
    ...
    ,
